...
class Legend(Subplot):
    ...
    def create_gene_legend(
        ...
        self.canvas.mpl_connect("figure_enter_event", self._on_mouse_enters)
        self.canvas.mpl_connect("figure_leave_event", self._on_mouse_exits)
    ...
    def _on_mouse_enters(self, _: Optional[Event] = None) -> None:
        self.mouse_is_over_legend = True

    def _on_mouse_exits(self, _: Optional[Event] = None) -> None:
        self._clear_mouse_hovers()
        self.mouse_is_over_legend = False

    def _clear_mouse_hovers(self, _: Optional[Event] = None, do_redraw: bool = True) -> None:
