...
def generate_global_image(
    ...
    """
    Stitch together potentially overlapping images.

    The images are tiles and are stitched together based on the stitch results provided for positioning each tile. The
    tile overlap is resolved using linear interpolation.
    ...
    Args:
        ...
        output_dtype (dtype-like, optional): the fused_image final datatype. If an integer is given, the resulting
            linear interpolation is rounded. Default: float16.
