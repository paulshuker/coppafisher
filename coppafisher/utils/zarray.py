...
def convert_group_to_zip_store(group_path: str) -> None:
    """
    ...
    temp_path = os.path.join(temp_dir.name, os.path.basename(group_path))
...
def convert_array_to_zip_store(array_path: str) -> None:
    """
