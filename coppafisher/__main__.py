...
#
#     python3 -m coppafisher config.ini

import argparse

from coppafisher import Notebook, Viewer, run_pipeline
from coppafisher.plot import view_find_spots

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run coppafisher pipeline or diagnostics")
