...
def set_log_config(
    ...
    coppafisher is run. The log config is set automatically with all defaults when coppafisher is imported. But, it can
    then be overwritten by calling this function again.
