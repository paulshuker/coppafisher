...
def score_coefficient_image(
    ...
    """
    Computes the OMP score image for the coefficient image(s). The score image is the coefficient image convolved with
    the mean spot divided by the mean spot's sum.
